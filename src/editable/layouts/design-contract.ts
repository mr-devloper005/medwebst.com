...
export const editableRootStyle = {
  ...
  '--slot4-soft-muted-text': '#767676',
  '--slot4-accent': '#d21f86',
  '--slot4-accent-fill': '#d21f86',
  '--slot4-accent-soft': '#fae1f1',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#172a3d',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#e8ecef',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#f0f0f0',
  '--slot4-lavender': '#c9b5dc',
  '--slot4-gray': '#eeeeee',
  '--slot4-body-gradient': 'none',
  '--editable-page-bg': '#ffffff',
  '--editable-page-text': '#121212',
  '--editable-container': '1280px',
  '--editable-border': '#d9d9d9',
  '--editable-nav-bg': '#ffffff',
  '--editable-nav-text': '#121212',
  '--editable-nav-active': '#d21f86',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#d21f86',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#172a3d',
