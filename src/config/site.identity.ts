export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'medwebst',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Medwebst',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'medwebst.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://medwebst.com',
